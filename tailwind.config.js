  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        mono: ['JetBrains Mono', 'SF Mono', 'Monaco', 'Menlo', 'Consolas', 'ui-monospace', 'monospace'],
      ...
      animation: {
        ...
        'pulse-ring': 'pulseRing 1.5s ease forwards',
      ...
      keyframes: {
        ...
        pulseRing: {
          '0%': { boxShadow: '0 0 0 2px hsl(var(--primary) / 0.4)' },
          '100%': { boxShadow: '0 0 0 0px hsl(var(--primary) / 0)' },
        },
        float1: {
